...
<section class = "form">
            <div class="row">
                ...
                <h2 class= "heading">Technical paper/Project contests Outside of institute By student</h2>
                ...
                <div class="row">
                    ...
                    <div    class = "col span-2-of-3">
                          <select name= "student"  id = "sname">
                            <option value = "class">Technical paper</option>
                            <option value = "se">project contests</option>
                        </select>
                    ...
                    <div    class = "col span-2-of-3">
                          <select name= "student"  id = "sname">
                            ...
                            <option value = "te">C</option>
                            <option value = "te">D</option>
                        </select>

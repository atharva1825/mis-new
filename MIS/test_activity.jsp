...
<section class = "form">
            <div class="row">
                ...
                <h2 class= "heading">Test Activity</h2>
                ...
                <div class="row">
                    ...
                    <div    class = "col span-2-of-3">
                          <select name= "student"  id = "sname">
                            <option value = "class">Unit test  </option>
                            <option value = "se">Moodle Test  </option>
                            <option value = "te">ICT activities  </option>
                            <option value = "te">VLAB activities  </option>
                            <option value = "te">other  </option>
                        </select> 
                    </div>
                       </div> 
                    ...
                    <div    class = "col span-2-of-3">
                          <select name= "student"  id = "sname">
                            ...
                            <option value = "te">Final Year  </option>
                        </select> 
                    </div>
                       </div> 
                    ...
                    <div    class = "col span-2-of-3">
                         <select name= "student"  id = "sname">
                             ...
                             <option value = "div">C  </option>
                             <option value = "div">D </option>
                        </select>
                    </div>
                       </div>
                    ...
                    <div    class = "col span-2-of-3">
                          <input type ="subject" name = "text" id = "text">
